...
# TN I love the idea of making an APA manuscript for this project, super useful and lots to learn from! I like the way you organized your functions, and it was easy to find them and it also makes the code cleaner 
# I dont know if it is the goal in this project, but explaining the step by step of how to create at least one of the functions would have been useful and informative - thinking of future audiences of this project 
...
#TN: great work with the data, very clear and clean coding!! It was useful to learn how to add subscales 

```{r data1_convert_to_long, include = FALSE}
# add an id column to the data
data1 %<>%
  mutate(id = 1:n()) %>%
  select(id, everything()) #TN: this is useful! I will use it on my own work 
...
#TN: great use of map to replace names! looks useful 
#TN: I like how you divided the code : all the code chunks preparing the data and functions are very well organized beofre the beginning of the main manuscript and the following chunks for the different sections of the paper are well organized and placed across the text, which makes the creation of an APA format pdf clear and straight forward. 
...
# TN great use of walk2 to save the plots!! 
