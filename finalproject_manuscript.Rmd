...
In terms of the Dark Triad traits, those higher in narcissism reported using Instagram [*b* = .79, *SE* = .31, *t*(1571.11) = 2.56, *p* = .011] and--marginally--Snapchat [*b* = .56, *SE* = .31, *t*(1571.11) = 1.81, *p* = .07] more frequently than Facebook. 
