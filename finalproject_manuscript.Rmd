...
source(here("functions", "con_to_cat.R"))    # CUSTOM FUNCTION 8: quantile 
...
$$L2: \beta_{1j} = \gamma_{10} + \gamma_{11}G{j} + \gamma_{12}M_{j} + \gamma_{13}N_{j} + \gamma_{14}P_{j}  + u_{1j}$$
...
model_comps_comb <- map2_df(model_comps_comb, 
