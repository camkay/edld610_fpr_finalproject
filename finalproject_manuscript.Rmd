...
# What if we wanted to visualize all three groups (low, mid, high)?
...
plot_data <- plot_data %>%
  mutate(plots = pmap(
    ...
    # create plots
    function(data_for_plot, dd_trait) {
      ggplot(data_for_plot, aes(x = standing, y = len, fill = standing)) +
        ...
        # set labels
        labs(title    = glue("Relation Between Time on Social Media and {dd_trait}"),
