...
# install packages if you do not have them installed already #I'm glad you kept this!
...
# load packages #This is also very informative!
...
**Something something something... TBD**
...
academic_theme <- theme(plot.subtitle = element_text(family = "Times"), #Well, this is pretty cool! 
...
plot1_mach <- data1 %>%
  ...
  ggplot(aes(x = mach_group, y = len_m, fill = mach_group)) +
    ...
    labs(y = "Average length spent on Social \nMedia Sites per Day (minutes)",
         x = "Machiavellianism")  #It's too bad that the reported data for 4chan is so low, I would imagine that Machiavellianism would be incredibly high!
...
Areas of strength
1) Very well annotated step-by-step code that I was able to follow (you two are also the first that I've seen use the manuscript format).
2) Clean, detailed plots that get the information across effectively (e.g., I like the plot grid to represent a variety of social media platforms)
3) I just want to acknowledge that you two put in an incredible amount of work/dedication for this project, which is reflected by the amount of detail and length of the manuscript.
 
What did I learn?
1) Whenever I read your code, I feel like that I'm learning more than anything else! If I had to pick one thing out, I would say that I enjoyed learning about how to create a custom theme (line 1064) to make a more professional plot (I could easily see this on a poster at a conference).

Area of improvement
1) Very minor suggestion--I think your code could benefit from more consistent allignment at times. I think that this would make it easier to follow functions and data tidying at on a few occasions.