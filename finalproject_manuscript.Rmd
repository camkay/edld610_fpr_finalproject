...
While females tended to visit social media sites more overall, analyzing the total time spend on social media per day (in minutes) revealed males and females did not significantly differ from one another in overall time spend on social media (*p* > .29). Results similarly indicated that males appeared to report spending more minutes per day on Reddit [*b* = 25.63, *SE* = 8.09, *t*(11552.29) = 3.17, *p* = .002] and Youtube [*b* = 37.96, *SE* = 8.09, *t*(11552.29) = 4.69, *p* < .001].
