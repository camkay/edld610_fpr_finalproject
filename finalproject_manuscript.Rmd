...
In regard to the Dark Triad traits, those higher in narcissism reported using Instagram [*b* = .79, *SE* = .31, *t*(1571.11) = 2.56, *p* = .011] and--marginally--Snapchat [*b* = .56, *SE* = .31, *t*(1571.11) = 1.81, *p* = .07] more frequently than Facebook. Interestingly, it appears this effect of Narcissism on Instagram use interacted with gender, such that female narcissists used Instagram less than male narcissists, *b* = -0.79, *SE* = .35, *t*(1571.11) = -2.27, *p* = .023. Those high in Machiavellianism used Reddit more than Facebook, *b* = .85, *SE* = .30, *t*(1571.11) = 2.84, *p* = .004. This effect again depended on gender. That is, females high in Machiavellianism  used Reddit less than males high in Machiavellianism, *b* = -0.92, *SE* = .38, *t*(1571.11) = -2.39, *p* = .017. Finally, the only effect to arise concerning psychopathy was an interaction between paychopathy, gender, psyc, and social media site. Specifically, females scoring higher in psychopathy reported using Reddit more than Facebook, *b* = .84, *SE* = .42, *t*(1571.11) = 1.99, *p* = .047.
