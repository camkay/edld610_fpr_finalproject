...
sample_start <- length(unique(data1$id))
...
exclusions_duration <- sample_start - length(unique(data1$id))
...
exclusions_sd <- sample_start - exclusions_duration - length(unique(data1$id))
...
exclusions_gender <- sample_start - exclusions_duration - exclusions_sd - length(unique(data1$id))
